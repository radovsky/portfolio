...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'css/style.css', containers: 1140 },
			'wide':		{ range: '-1680', href: 'css/style-wide.css', containers: 960 },
			'normal':	{ range: '-1080', href: 'css/style-normal.css', containers: '95%' },
			'narrow':	{ range: '-840', href: 'css/style-narrow.css', grid: { gutters: 30 } },
			'mobile':	{ range: '-640', href: 'css/style-mobile.css', lockViewport: true, grid: { collapse: true, gutters: 20 } }
		}
	});
